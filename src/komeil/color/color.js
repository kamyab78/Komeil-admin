...
console.log(response)
                ...
                response.json().then(rep => {
                    ...
                    allData.push({
                        ...
                        imageurl: item.hex ? item.hex : "تنظیم نشده است",
                        promote: item.enable ,
                    });
                });
                setUsers(allData);
    ...
    const columns = [
        {
            ...
            render: item => <div className='profile-pic-container'>
                <p style={{backgroundColor:item}} className="profile-pic"/>
            </div>,
    ...
    function deleteHandler() {
        ...
        setDeleteLoading(true)
            ...
            fetch(Config()['apiUrl'] + "/admin/changestatecolor?id="+idSelected.key+"&username="+localStorage.getItem('username'), requestOptions)
                .then(response => {
    ...
    function createHandler() {
        ...
        if (idSelected) {
            ...
            fetch(Config()['apiUrl'] + "/admin/color?id="+idSelected.key+"&username="+localStorage.getItem('username'), requestOptions)
                .then(response => {
    ...
    return (
        <div className='color-list-page'>
            <Modal closable={false} className='color-preview-modal' footer={[
                <Button onClick={() => {
                    setIsModalOpen(false);
                    setIdSelected(null)
                }} key="back">
                ...
                {idSelected && <div className='color-modal-preview'>
            ...
            <Modal closable={false} className='color-delete-modal' footer={[
                <Button onClick={() => {
                    setDeleteModal(false);
                    setIdSelected(null)
                }} key="back">
            ...
            <Modal closable={false} className='color-delete-modal' footer={[
                ...
                <div className='create-color-modal-preview'>
            ...
            <Card title={
                <div className='get_list_color_title'>
                    <p>لیست رنگ ها</p>
                    <span/>
                    <Button onClick={() => setCreatecolorModal(true)} type={"primary"}>ثبت رنگ جدید</Button>
                </div>
