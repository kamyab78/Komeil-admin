...
const Transport = function (props) {
    ...
    function getData() {
        ...
        fetch(Config()['apiUrl'] + "/admin/transport?username="+localStorage.getItem('username'), requestOptions)
            .then(response => {
                ...
                response.json().then(rep => {
                    ...
                    allData.push({
                        key: item.id,
                        topic:
                            item.transport !== null ? item.transport : "تنظیم نشده است",
                            promote: item.enable
    ...
    function deleteHandler() {
        ...
        setDeleteLoading(true)
            ...
            fetch(Config()['apiUrl'] + "/admin/changestatetransport?Id="+idSelected.key+"&username="+localStorage.getItem('username'), requestOptions)
                .then(response => {
    ...
    function createHandler() {
        ...
        if (idSelected) {
            ...
            fetch(Config()['apiUrl'] + "/admin/transport?Id="+idSelected.key+"&username="+localStorage.getItem('username'), requestOptions)
                .then(response => {
    ...
    return (
        <div className='transport-list-page'>
            <Modal closable={false} className='transport-preview-modal' footer={[
                <Button onClick={() => {
                    setIsModalOpen(false);
                    setIdSelected(null)
                }} key="back">
                ...
                {idSelected && <div className='transport-modal-preview'>
            ...
            <Modal closable={false} className='transport-delete-modal' footer={[
                <Button onClick={() => {
                    setDeleteModal(false);
                    setIdSelected(null)
                }} key="back">
            ...
            <Modal closable={false} className='transport-delete-modal' footer={[
                ...
                setImageUploader(null)
                    setPromote(false)
            }} visible={createtransportModal}>

                <div className='create-transport-modal-preview'>
            ...
            <Card title={
                <div className='get_list_transport_title'>
                    <p>لیست نحوه ارسال</p>
                    <span/>
                    <Button onClick={() => setCreatetransportModal(true)} type={"primary"}>ثبت روش جدید</Button>
                </div>
